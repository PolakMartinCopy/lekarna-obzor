...
<div id="search_form_c_s_invoices"<?php echo $hide?>>
	...
	<table class="left_heading">
		...
		<tr>
			...
			<th>Jazyk</th>
			<td><?php echo $this->Form->input('CSInvoice.language_id', array('label' => false, 'empty' => true))?></td>
		</tr>
		<tr>
			<th>Měna</th>
			<td><?php echo $this->Form->input('CSInvoice.currency_id', array('label' => false, 'empty' => true))?></td>
