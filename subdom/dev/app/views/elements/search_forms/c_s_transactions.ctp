...
<div id="search_form_c_s_transactions"<?php echo $hide?>>
	...
	<table class="left_heading">
		...
		<tr>
			<th>Obchodník</th>
			<td><?php echo $this->Form->input('CSTransaction.user_id', array('label' => false, 'empty' => true))?></td>
			<th>Datum splatnosti od</th>
			<td><?php echo $this->Form->input('CSTransaction.due_date_from', array('label' => false))?></td>
			<th>Datum splatnosti do</th>
			<td><?php echo $this->Form->input('CSTransaction.due_date_to', array('label' => false))?></td>
		</tr>
		<tr>
			<td>Zboží</td>
		</tr>
